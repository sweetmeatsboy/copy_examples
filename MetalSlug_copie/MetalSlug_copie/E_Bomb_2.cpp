...
const RTTI CE_Bomb_2::m_Rtti("CE_Bomb_2", CEnemyBullet::m_Rtti);

void CE_Bomb_2::isOutOfFocus()
{
...
void CE_Bomb_2::SetAngle(float _fAngle)
{
...
void CE_Bomb_2::CheckLineCollision()
{
...
void CE_Bomb_2::CheckCollision(CObj* _Something)
{
	if (_Something->GetRTTI().isExactly(CPlayer::m_Rtti))
		isDead = true;
}

void CE_Bomb_2::Initialize(void)
{
